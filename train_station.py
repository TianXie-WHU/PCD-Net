"""Stage 3: fine-tune PCD-Net with in situ LST observations."""
...
def main():
    ...
    parser.add_argument("--checkpoint-dir", default="models/simulation_finetuned")
    parser.add_argument("--output-dir", default="models/site_finetuned")
